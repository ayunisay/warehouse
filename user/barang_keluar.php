        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-8 mt-8">
            ...
            <form method="POST">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="keterangan" name="keterangan" rows="4" class="w-full px-1 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-left" placeholder="Masukkan keterangan" value="" required>  <?php echo $edit_data ? htmlspecialchars($edit_data['keterangan']) : ''; ?>
                    </textarea>
                </div>
