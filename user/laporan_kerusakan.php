        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <form method="POST">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="4" class="w-full py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="Jelaskan kerusakan atau kehilangan barang" required>  <?php echo $edit_data ? htmlspecialchars($edit_data['deskripsi']) : ''; ?>
                </textarea>
                </div>
